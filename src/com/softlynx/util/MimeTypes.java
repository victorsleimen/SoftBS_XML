...
public class MimeTypes {
	...
	static {
		...
		mimeTypes.put("bin",
				"application/octet-stream,application/mac-binary,application/macbinary,application/x-binary,application/x-macbinary");
		...
		mimeTypes.put("c++", "application/x-cplusplus,text/x-c++src,text/plain");
		mimeTypes.put("cab",
				"application/vnd.ms-cab-compressed,application/cab,application/x-compress,application/x-compressed,zz-application/zz-winassoc-cab");
		...
		mimeTypes.put("class",
				"application/octet-stream,application/java,application/java-byte-code,application/x-java-class");
		...
		mimeTypes.put("hqx",
				"application/mac-binhex40,application/binhex,application/binhex4,application/mac-binhex,application/x-binhex40,application/x-mac-binhex40");
		...
		mimeTypes.put("mid",
				"audio/midi,application/x-midi,audio/x-mid,audio/x-midi,music/crescendo,x-music/x-midi,audio/mid");
		...
		mimeTypes.put("ppt",
				"application/mspowerpoint,application/powerpoint,application/vndms-powerpoint,application/x-mspowerpoint");
		...
		mimeTypes.put("url",
				"wwwserver/redirection,application/internet-shortcut,application/x-url,message/external-body,text/url,text/x-url");
	...
	/**
	 * Returns the content-type for given filename by using mime-type.properties as
	 * dictionary for filename-extension.
	 */
