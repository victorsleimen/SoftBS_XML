...
public final class UtilIO {
	...
	final static Logger logger = LoggerFactory.getLogger(UtilIO.class);
	...
	/**
	 * Copy an InputStream to an OutputStream, optionally closing either the input
	 * or the output.
	 *
	 * @param in
	 *            the InputStream to copy from
	 * @param closeIn
	 *            whether to close the input when the copy is done
	 * @param out
	 *            the OutputStream to copy to
	 * @param closeOut
	 *            whether to close the output when the copy is done
	 * @throws IOException
	 *             if an error occurs
	 */
	 ...
	 * This uses a default {@link Charset UTF-8} charset.
	 *
	 * @param bytes
	 *            the array of bytes to convert
	 * @return the converted string, with platform line endings converted to \n
	 */
	...
	/**
	 * Convert a byte array to a string; consistently uses \n line endings in java.
	 * The conversion is limited to the specified offset/length pair, and uses a
	 * default {@link Charset UTF-8} charset.
	 *
	 * @param bytes
	 *            the array of bytes to convert
	 * @param offset
	...
	/**
	 * Convert a byte array to a string; consistently uses \n line endings in java.
	 * The conversion is limited to the specified offset/length pair, and uses the
	 * requested charset to decode the bytes.
	 *
	 * @param bytes
	 *            the array of bytes to convert
	 * @param charset
	...
	/**
	 * Convert a byte array to a string, consistently uses \n line endings in java.
	 * The specified {@link Charset charset} is used to decode the bytes.
	 * 
	 * @param bytes
	 *            the array of bytes to convert
	 * @param charset
	 ...
	 * Convert a byte array to a string, consistently uses \n line endings in java.
	 * The conversion is limited to the specified offset/length pair, and uses the
	 * requested {@link Charset charset} to decode the bytes.
	 *
	 * @param bytes
	 *            the array of bytes to convert
	 * @param offset
	 ...
	 *
	 * @param reader
	 *            the stream of characters convert
	 * @return the converted string, with platform line endings converted to \n
	 */
	public static final String readString(Reader reader) throws IOException {
		try {
			...
			try {
				...
				logger.error("Error closing after reading text: " + e.toString(), module);
			}
		}
	}
	 ...
	 *
	 * @param file
	 *            where to write the converted bytes to
	 * @param value
	 *            the value to write
	 */
