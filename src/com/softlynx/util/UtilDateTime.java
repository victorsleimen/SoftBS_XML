...
public final class UtilDateTime {
	...
	final static Logger logger = LoggerFactory.getLogger(UtilDateTime.class);
	/**
	...
	public static String toDateFormat(Date date, String dateFormat) {
	...
	/**
	 * Makes a Timestamp from separate ints for month, day, year, hour, minute, and
	 * second.
	 *
	 * @param month
	 *            The month int
	 ...
	 * @param secondStr
	 *            The second String
	 * @return A Date made from separate Strings for month, day, year, hour, minute,
	 *         and second.
	 */
	...
	/**
	 * Makes a time String in the format HH:MM:SS from a Date. If the seconds are 0,
