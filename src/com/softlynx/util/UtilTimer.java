...
public class UtilTimer {
	...
	final static Logger logger = LoggerFactory.getLogger(UtilTimer.class);
	...
	public String timerString(String message, String module) {
		...
		if (log)
			logger.debug(retString, "org.apache.ofbiz.base.util.UtilTimer");
	 ...
	 * since the last call, and the time since the beginning. This version allows an
	 * integer level to be specified to improve readability of the output.
	 * 
	 * @param level
	 *            Integer specifying how many levels to indent the timer string so
	 *            the output can be more easily read through nested method calls.
	 * @param message
	 *            A message to put into the timer String
	 * @return A String with the timing information, the timer String
	 */
