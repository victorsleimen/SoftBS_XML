...
public class UtilMessageString implements Serializable {

	public static final String module = UtilMessageString.class.getName();
	...
	public static List<Object> getMessagesForField(String fieldName, boolean convertToStrings,
			List<Object> messageStringList) {
		if (fieldName == null) {
	...
	public static List<Object> getMessagesForField(String fieldName1, String fieldName2, String fieldName3,
			String fieldName4, boolean convertToStrings, List<Object> messageStringList) {
		Set<String> fieldSet = new TreeSet<String>();
	...
	public static List<Object> getMessagesForField(Set<String> fieldNameSet, boolean convertToStrings,
			List<Object> messageStringList) {
		...
		for (Object messageStringCur : messageStringList) {
			if (messageStringCur instanceof UtilMessageString) {
				UtilMessageString messageString = (UtilMessageString) messageStringCur;
	 ...
	 * @param propertyName
	 */
	public UtilMessageString(String message, String fieldName, String propertyResource, String propertyName,
			Locale locale, boolean isError) {
	 ...
	 * @param fieldName
	 */
	public UtilMessageString(String message, String fieldName, boolean isError) {
		this.message = message;
		this.fieldName = fieldName;
		this.isError = isError;
	}
	 ...
	 * @param sourceError
	 */
	public UtilMessageString(String message, String fieldName, String toFieldName, Throwable sourceError) {
		this.message = message;
		this.fieldName = fieldName;
	 ...
	 * @param sourceError
	 */
	public UtilMessageString(String message, Throwable sourceError) {
		this.message = message;
		this.sourceError = sourceError;
		this.isError = true;
	}
