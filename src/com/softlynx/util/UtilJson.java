...
public class UtilJson {
	...
	public static Object fileToObject(File jsonFile) throws IOException {
		return stringToObject(UtilStream.readFile(jsonFile));
	}

	/**
	 * 
	 * Given a string containing valid JSON, return it's Java object representation.
	 * 
	 * @param jsonStr
	...
	private static void parseNVPList(String name, List<NVP> nvpList, Object jsonObj) {
