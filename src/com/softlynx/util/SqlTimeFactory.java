...
public class SqlTimeFactory {
	 ...
	 *
	 * @return A Timestamp containing the current time as known by the machine on
	...
	/**
	 *
	 * This routine returns a timestamp containing the current time offset by a
	 * specified number of milliseconds.
	 *
	 * @param offset
	 *            The number of milliseconds to offset this time by.
	 *
	 * @return A Timestamp containing the current time offset by the given offset.
	 *         Current time is the current time as known by the machine on which
	...
	/**
	 *
	 * This is a convenience function to convert a java.util.date to a Timestamp.
	 *
	 * @param date
	 *            The date to convert.
	 *
