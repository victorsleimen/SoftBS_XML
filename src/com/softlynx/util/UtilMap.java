...
public class UtilMap {
	 ...
	 * 
	 */
	public final static int getInt(Map<?, ?> map, Object key) throws NotFoundException {
		if (!map.containsKey(key))
			throw new NotFoundException(key + " not found.");

		return (Integer.valueOf(map.get(key).toString())).intValue();
	}
	...
	public final static boolean getBoolean(Map<?, ?> map, Object key, boolean defaultValue) {
		if (!map.containsKey(key))
			return defaultValue;
	 ...
	 * 
	 */
	public final static long getLong(Map<?, ?> map, Object key) throws NotFoundException {
		if (!map.containsKey(key))
			throw new NotFoundException(key + " not found.");
	 ...
	 * 
	 */
	public final static float getFloat(Map<?, ?> map, Object key) throws NotFoundException {
		if (!map.containsKey(key))
			throw new NotFoundException(key + " not found.");

		return (Float.valueOf(map.get(key).toString())).floatValue();
	}
	 ...
	 * 
	 */
	public final static double getDouble(Map<?, ?> map, Object key) throws NotFoundException {
		if (!map.containsKey(key))
			throw new NotFoundException(key + " not found.");

		return (Double.valueOf(map.get(key).toString())).doubleValue();
	}
	 ...
	 * 
	 */
	public final static String getString(Map<?, ?> map, Object key) throws NotFoundException {
		if (!map.containsKey(key))
			throw new NotFoundException(key + " not found.");
	 ...
	 * 
	 */
	public final static String getString(Map<?, ?> map, Object key, String defaultValue, boolean defaultValueOnEmpty) {
		if (!map.containsKey(key))
			return defaultValue;
	 ...
	 * doesn't exist, or is shorter than minLength, return the default value. If the
	 * element's length exceeds maxlength, truncate the returned value to maxLength
	 * characters.
	 * 
	 * @param map
	 ...
	 * @return The string value of the element referenced by key.
	 */
	public final static String getString(Map<?, ?> map, Object key, String defaultValue, int minLength, int maxLength) {
		String returnString = "";
	...
	/**
	 * 
	 * Return the String value of the element referenced by "key" and turn it to all
	 * lowercase.
	 * 
	 * @param map
	 *            The hashmap to search in.
	 ...
	 * 
	 */
	public final static String getLowerCaseString(Map<?, ?> map, Object key) throws NotFoundException {
		return getString(map, key).toLowerCase();
	}

	/**
	 * 
	 * Return the String value of the element referenced by "key" and and converted
	 * to lowercase.
	 * 
	 * @param map
	 *            The hashmap to search in.
	 ...
	 * 
	 */
	public final static String getLowerCaseString(Map<?, ?> map, Object key, String defaultValue) {
	 ...
	 * doesn't exist, or is shorter than minLength, return the default value. If the
	 * element's length exceeds maxlength, truncate the returned value to maxLength
	 * characters. Convert the result to lowercase when finished.
	 * 
	 * @param map
	 *            The hashmap to search.
	 * @param key
	 ...
	 * 
	 */
	public final static String getLowerCaseString(Map<?, ?> map, Object key, String defaultValue, int minLength,
			int maxLength) {
	 ...
	 * 
	 */
	public final static String getUpperCaseString(Map<?, ?> map, Object key) throws NotFoundException {
	 ...
	 * 
	 */
	public final static String getUpperCaseString(Map<?, ?> map, Object key, String defaultValue) {
	 ...
	 * doesn't exist, or is shorter than minLength, return the default value. If the
	 * element's length exceeds maxlength, truncate the returned value to maxLength
	 * characters. Convert the result to uppercase when finished.
	 * 
	 * @param map
	 *            The hashmap to search.
	 * @param key
	 ...
	 * 
	 */
	public final static String getUpperCaseString(Map<?, ?> map, Object key, String defaultValue, int minLength,
			int maxLength) {
